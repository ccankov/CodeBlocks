...
css3 = Language.create(name: 'css3')
elixir = Language.create(name: 'elixir')
elm = Language.create(name: 'elm')
haskell = Language.create(name: 'haskell')
html5 = Language.create(name: 'html5')
java = Language.create(name: 'java')
perl = Language.create(name: 'perl')
php = Language.create(name: 'php')
python = Language.create(name: 'python')
sass = Language.create(name: 'sass')
r = Language.create(name: 'r')
shell = Language.create(name: 'shell')
docker = Language.create(name: 'docker')
